...
class Folder
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Routine::class, mappedBy: 'folder')]
    ...
    public function removeRoutine(Routine $routine): static
    {
        if ($this->routines->removeElement($routine)) {
            ...
            if ($routine->getFolder() === $this) {
                $routine->setFolder(null);
            }
        }
